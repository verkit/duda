        ...
        <div class="padding">
            ...
            <div class="card">
                <div class="card-header">
                    <strong>Edit product {{$product->product_name}}
                    </strong>
                </div>
                <div class="card-body">
                    <form action="{{route('product.update', $product->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Ex. Backlink"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="subservice">
                                ...
                                <option value="{{$item->id}}" @if ($product->id_subservice == $item->id)
                                    selected
                                    @endif >{{$item->sub_service_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="price" name="price"
                                value="{{$product->price}}" placeholder="Ex. 500000">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="mt-2 mb-2">
                                <div class="form-check form-check-inline">
                                    <label class="ui-check ui-check-color">
                                        <input type="radio" name="status" value="aktif" @if ($product->status
                                        =="aktif")
                                        checked
                                        @endif>
