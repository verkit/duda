...
<div id="content" class="flex ">
    ...
    <div class="page-container" id="page-container">
        <div class="page-title padding pb-0 ">
            <h2 class="text-md mb-0">Bank account</h2>
        </div>
        <div class="padding">
            ...
            <a href="{{route('bank.create')}}" class="btn w-sm btn-primary mb-3">Add account</a>
            {{-- <div id="toolbar">
            ...
            <table class="table table-theme v-middle" data-plugin="bootstrapTable" id="table" data-toolbar="#toolbar"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-sortable="true">Account Number</th>
