        ...
        <div class="padding">
            ...
            <div class="card col-sm-6">
                <div class="card-header">
                    <strong>Edit sub service
                </div>
                <div class="card-body">
                    <form action="{{route('service.sub.update', ['id'=>$sub->id_service,'sub'=>$sub->id])}}"
                        method="POST">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Enter sub service name" value="{{$sub->sub_service_name}}">
                        </div>
                        <div class="form-group">
                            <label class="text-muted" for="desc">Description</label>
                            <textarea class="form-control" rows="7" name="description">{{$sub->description}}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="mt-2 mb-2">
                                <div class="form-check form-check-inline">
                                    <label class="ui-check ui-check-color">
                                        <input type="radio" name="status" value="aktif" @if ($sub->status
                                        =="aktif")
                                        checked
                                        @endif>
